...
#include "esp_log.h"
static const char* TAG_PRO = "APP_PROV";
#define app_log_warning(...)                  ESP_LOGW(TAG_PRO,__VA_ARGS__)
#define app_log_info(...)                     ESP_LOGI(TAG_PRO,__VA_ARGS__)
#define app_log_error(...)                    ESP_LOGE(TAG_PRO,__VA_ARGS__)
#define app_log_debug(...)                    ESP_LOGD(TAG_PRO,__VA_ARGS__)
#define app_log_status_error_f(a,...)         ESP_LOGE(TAG_PRO,__VA_ARGS__); ESP_LOGE(TAG_PRO,"err: 0x%x",a)
#define app_log_status_warning_f(a,...)       ESP_LOGW(TAG_PRO,__VA_ARGS__); ESP_LOGE(TAG_PRO,"war: 0x%x",a)
