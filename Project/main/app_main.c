...
*/
#define EXAMPLE_ESP_WIFI_SSID      "hoang"
#define EXAMPLE_ESP_WIFI_PASS      "hoang8888"
...
// extern rgb_led_pwm_init;
// extern rgb_led_set_color;
...
void rgb_callback(uint8_t r, uint8_t g, uint8_t b)
{
    rgb_led_test(r,g,b);
}
